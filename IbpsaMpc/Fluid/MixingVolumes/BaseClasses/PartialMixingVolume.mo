within IbpsaMpc.Fluid.MixingVolumes.BaseClasses;
model PartialMixingVolume
  "Partial mixing volume with inlet and outlet ports (flow reversal is allowed)"

  extends IbpsaMpc.Fluid.Interfaces.LumpedVolumeDeclarations;
...
protected
  IbpsaMpc.Fluid.Interfaces.StaticTwoPortConservationEquation steBal(
  ...
  IbpsaMpc.Fluid.Interfaces.ConservationEquation dynBal(
    final simplify_mWat_flow = simplify_mWat_flow,
    redeclare final package Medium = Medium,
...
<a href=\"modelica://IbpsaMpc.Fluid.MixingVolumes\">
IbpsaMpc.Fluid.MixingVolumes</a>.
</p>
...
then the model uses
<a href=\"modelica://IbpsaMpc.Fluid.Interfaces.StaticTwoPortConservationEquation\">
...
if allowFlowReversal then
  hOut = IbpsaMpc.Utilities.Math.Functions.regStep(y1=port_b.h_outflow,
                                                    y2=port_a.h_outflow,
                                                    x=port_a.m_flow,
...
<code>IbpsaMpc.Fluid.Chillers.Carnot_y</code>
...
Revised base classes for conservation equations in <code>IbpsaMpc.Fluid.Interfaces</code>.
</li>
<li>
...
<a href=\"IbpsaMpc.Fluid.Interfaces.LumpedVolumeDeclarations\">
...
<a href=\"modelica://IbpsaMpc.Fluid.MixingVolumes.BaseClasses.PartialMixingVolumeWaterPort\">
IbpsaMpc.Fluid.MixingVolumes.BaseClasses.PartialMixingVolumeWaterPort</a>,
...
<a href=\"modelica://IbpsaMpc.Fluid.MixingVolumes.BaseClasses.ClosedVolume\">
IbpsaMpc.Fluid.MixingVolumes.BaseClasses.ClosedVolume</a>.
</li>
</ul>
</html>"),
