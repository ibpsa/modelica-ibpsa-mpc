within IbpsaMpc.Fluid.MixingVolumes;
model MixingVolume
  "Mixing volume with inlet and outlet ports (flow reversal is allowed)"
  extends IbpsaMpc.Fluid.MixingVolumes.BaseClasses.PartialMixingVolume(
...
CO2 to the volume.
See
<a href=\"modelica://IbpsaMpc.Fluid.Sensors.Examples.PPM\">IbpsaMpc.Fluid.Sensors.Examples.PPM</a>
for an example.
</p>
...
<a href=\"modelica://IbpsaMpc.Fluid.MixingVolumes.BaseClasses.PartialMixingVolume\">
IbpsaMpc.Fluid.MixingVolumes.BaseClasses.PartialMixingVolume</a>.
</p>
<p>
For simple models that uses this model, see
<a href=\"modelica://IbpsaMpc.Fluid.HeatExchangers.HeaterCooler_u\">
IbpsaMpc.Fluid.HeatExchangers.HeaterCooler_u</a> and
<a href=\"modelica://IbpsaMpc.Fluid.Humidifiers.Humidifier_u\">
IbpsaMpc.Fluid.Humidifiers.Humidifier_u</a>.
</p>
