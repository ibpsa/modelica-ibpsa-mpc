...
model StaticTwoPortConservationEquation
  ...
  extends IbpsaMpc.Fluid.Interfaces.PartialTwoPortInterface;
...
equation
  ...
  if use_m_flowInv then
    m_flowInv = IbpsaMpc.Utilities.Math.Functions.inverseXRegularized(
                       x=port_a.m_flow,
  ...
  if allowFlowReversal then
    ...
    XiOut = IbpsaMpc.Utilities.Math.Functions.regStep(y1=port_b.Xi_outflow,
                                                     y2=port_a.Xi_outflow,
                                                     x=port_a.m_flow,
                                                     x_small=m_flow_small/1E3);
    COut = IbpsaMpc.Utilities.Math.Functions.regStep(y1=port_b.C_outflow,
                                                    y2=port_a.C_outflow,
                                                    x=port_a.m_flow,
                                                    x_small=m_flow_small/1E3);
  else
...
<a href=\"modelica://IbpsaMpc.Fluid.MassExchangers.Examples.ConstantEffectiveness\">
IbpsaMpc.Fluid.MassExchangers.Examples.ConstantEffectiveness</a>.
</li>
<li>
...
<a href=\"modelica://IbpsaMpc.Utilities.Math.Functions.inverseXRegularized\">
IbpsaMpc.Utilities.Math.Functions.inverseXRegularized</a>
