...
<p>
The package <code>IbpsaMpc.Fluid</code> consists of models
...
<tr>
  ...
  <td>Specific enthalpy <i>h</i> of the outflowing fluid, i.e.,
      ...
      <a href=\"modelica://IbpsaMpc.Fluid.Sensors.SpecificEnthalpyTwoPort\">
      IbpsaMpc.Fluid.Sensors.SpecificEnthalpyTwoPort</a>.</td>
</tr>
<tr>
  ...
  <td>Independent mixture mass fractions
      ...
      direction can do so using the sensor
      <a href=\"modelica://IbpsaMpc.Fluid.Sensors.MassFractionTwoPort\">
      IbpsaMpc.Fluid.Sensors.MassFractionTwoPort</a>.
...
<tr>
  ...
  <td>Trace substances <i>c<sub>i</sub>/m</i> close to the connection point, i.e.,
      ...
      Users who need to access the actual value for the given flow
      direction can do so using the sensor
      <a href=\"modelica://IbpsaMpc.Fluid.Sensors.TraceSubstancesTwoPort\">
      IbpsaMpc.Fluid.Sensors.TraceSubstancesTwoPort</a>.
      Note that this variable is only present for fluids that declare
      a trace substance such as CO<sub>2</sub>.
      See for example
      <a href=\"modelica://IbpsaMpc.Fluid.Sensors.Examples.TraceSubstances\">
      IbpsaMpc.Fluid.Sensors.Examples.TraceSubstances</a>.</td>
</tr>
</table>
...
<a href=\"modelica://IbpsaMpc.Fluid.Sources.Boundary_pT\">
IbpsaMpc.Fluid.Sources.Boundary_pT</a>,
...
<tr>
  ...
  <td>These parameter may be used
      ...
      See
      <a href=\"modelica://IbpsaMpc.Fluid.FixedResistances.PressureDrop\">
      IbpsaMpc.Fluid.FixedResistances.PressureDrop</a>.
  </td>
</tr>
<tr>
  <td>m_flow_nominal<br/>
...
<a href=\"modelica://IbpsaMpc.Fluid.Interfaces\">
IbpsaMpc.Fluid.Interfaces</a>
and from
