within ;
package IbpsaMpc "Building component model library for Model Predictive Control"
...
<p>
The following grants supported the development of the <code>IbpsaMpc</code> library:
</p>
<ul>
<li>
LBNL
